...
class Program
{
    static void Main()
    {
        ...
        customers.Add(1, new Customer(1, "Nandhini"));
        customers.Add(2, new Customer(2, "Mogane"));

        Order order1 = new Order(101, 1, "accessories");
        Order order2 = new Order(102, 2, "Shoes");
