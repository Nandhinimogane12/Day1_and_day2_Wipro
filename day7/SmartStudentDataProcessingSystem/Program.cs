...
class Program
{
    static void Main(string[] args)
    {
        ...
        manager[0] = new Student(101, "Anch", 85);
        manager[1] = new Student(102, "Pia", 75);
        manager[2] = new Student(103, "Dhoni", 95);
        manager[3] = new Student(104, "Virat", 65);
        manager[4] = new Student(105, "Kholi", 88);
        ...
        {
            sw.WriteLine("101 Asha 85");
            sw.WriteLine("102 Bala 75");
        }

        // Append
        using (StreamWriter sw = File.AppendText(filePath))
        {
            sw.WriteLine("103 Cathy 95");
        }
